export default function Home() {
  return (
    <main className="h-full flex flex-col items-center justify-center text-slate-400 p-8 text-center bg-slate-50/30 dark:bg-slate-900/30">
      ...
      <h1 className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-slate-100 mb-3">Welcome to MindForge</h1>
      <p className="max-w-md text-slate-500 dark:text-slate-400 text-base md:text-lg">
